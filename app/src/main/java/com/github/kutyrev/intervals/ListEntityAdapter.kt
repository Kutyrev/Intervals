...
class ListEntityAdapter(private val onClick: (ListEntity) -> Unit, private val onSwipeDeleteList: (ListEntity, Int) -> Unit) : ListAdapter<ListEntity, ListEntityHolder>(LISTENTITY_COMPARATOR), SwipeToDeleteCallback.OnSwipeDeleteListener {
